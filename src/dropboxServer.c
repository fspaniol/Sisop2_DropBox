...
// Funções do REPLICA MANAGER

// Thread paralela que aguarda conexões de outras replicas
void *listenForReplicas() {
    ...
    while (1) {
        ...
        replica = accept(socketListener, (struct sockaddr *) &depositoServidor[cont], &tamanhoEndereco[cont]);
